                                ...
                                <div class="panel-body"> 
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                            <h3 class="panel-title">Lokasi Apotik & Dokter Praktek</h3>
                                            ...
                                            <table id="table" class="table datatable" cellspacing="0" width="100%">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th style="width:250px;"><i class="fa fa-road"></i> Alamat</th>
                                                        <th style="width:200px;"><i class="fa fa-building-o"></i> Jenis</th>
                                                        <th style="width:200px;"><i class="fa fa-phone-square"></i> Telp</th>
                                        ...
                                        $(document).ready(function() {
                                            ...
                                            table = $('#table').DataTable({ 
                                                ...
                                                "ajax": {
                                                    "url": "<?php echo site_url('capotik_dokterpraktek/json')?>",
                                                    "type": "POST"
                                                },
