                                ...
                                <div class="panel-body"> 
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                            <h3 class="panel-title">Jadwal Kapal Ferry</h3>
                                            ...
                                            <table id="table" class="table datatable" cellspacing="0" width="100%">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <!--<th>ID</th>-->
                                                        <th><i class="fa fa-bookmark"></i> Nama Kapal</th>
                                                        <!--<th>Hari</th>-->
                                                        <th style="width:300px;"><i class="fa fa-calendar"></i> Tanggal Keberangkatan</th>
                                        ...
                                        $(document).ready(function() {
                                            ...
                                            table = $('#table').DataTable({ 
                                                ...
                                                "ajax": {
                                                    "url": "<?php echo site_url('cjadwal_kapal/json')?>",
                                                    "type": "POST"
                                                },
